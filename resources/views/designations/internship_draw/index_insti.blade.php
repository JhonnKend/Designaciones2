@component('components.index_card')
    @slot('title')
        Lista de Alumnos Designados de Institutos
    @endslot    
    @slot('bodycard')
                    ...
                    @foreach($list_students as $d)
                        <tr>
                            ...
                            @if($d->status_designation === 1)
                                ...
                                <td>
                                    @can('view_designation')<a href="{{ route('view_designation_insti') }}" class="btn btn-primary btn-sm show_function"  value="{{ $d->id_student }}" title="Ver Designacion" data-original-title="More Color"> <i class="fas fa-trash-altt"></i> Ver Designacion</a>@endcan                                    
                                </td>
                            @else
